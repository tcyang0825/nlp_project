...
parser.add_argument("--recall_num", type=int, default=5, help="Most similair number of doc recalled from corpus per query")
parser.add_argument("--label", type=str, default='', help="The label used in result.csv")
